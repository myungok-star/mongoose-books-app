...
// // get all books (Older Version before assemblying)
...
// get all books (New Version - rerouting)
app.get('/api/books', function (req, res) {
  // send all books as JSON response
  db.Book.find()
...
// create new book (Old Version before assemblying)
...
// create new book (New Version - rerouting)
app.post('/api/books', function (req, res) {
  // create new book with form data (`req.body`)
